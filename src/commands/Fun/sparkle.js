...
module.exports.run = async (client, message) => {
  ...
  if (message.mentions.users.first()) {
    ...
    if (targetMember.manageable) return message.send('❌ **The member\'s role is higher than mine!**');
    ...
    if (selfMember.manageable) return message.send('❌ **Your role is higher than mine!**');
