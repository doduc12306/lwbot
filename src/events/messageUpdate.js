...
module.exports = async (client, oldMessage, newMessage) => {
  ...
  const modLogChannel = newMessage.guild.channels.find(g => g.name === client.settings.get(newMessage.guild.id)['modLogChannel']);
  ...
  const embed = new RichEmbed()
    ...
    .setAuthor(newMessage.author.tag, newMessage.author.displayAvatarURL, newMessage.url)
